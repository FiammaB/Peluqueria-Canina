...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btGuardar.setText("Guardar edicion");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btGuardar, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(91, 91, 91))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
       //todos los datos de la mascota
        ...
        control.modificarMascota(masco,nombreMasco,raza,color,observacion,alergia,AtenEsp,nombreDuenio,celDuenio);
        //mensaje de todo ok
        mostrarMensaje("edicion Realizada correctamente", "Info", "Edicion Correcta");
        VerDatos pantDatos = new VerDatos();
        pantDatos.setVisible(true);
        pantDatos.setLocationRelativeTo(null);
        this.dispose();
    ...
    private void cargarDatos(int num_cliente) {
        ...
        txtCelDuenio.setText(masco.getDuenio().getCelDuenioString());
